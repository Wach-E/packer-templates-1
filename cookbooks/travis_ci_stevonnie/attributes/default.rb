...
override['travis_docker']['version'] = '5:20.10.14~3-0~ubuntu-xenial'
override['travis_docker']['binary']['version'] = '20.10.14'
...
override['travis_docker']['binary']['url'] = 'https://download.docker.com/linux/static/stable/x86_64/docker-20.10.14.tgz'
